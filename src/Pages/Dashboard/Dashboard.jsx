  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 ">
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between ">
            <div className="flex items-center justify-content-center rtl:justify-end">
              <img src={logo} className="mx-10  h-12 me-4" alt="Solo Rent" />
            </div>
          </div>
        </div>
      </nav>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 pt-3 ">
          <ul className="space-y-2 font-medium">
            <Link to="/dashboard/dashboardview">
              <li>
                <div className="flex items-center p-2 mb-5 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg
            ...
            <Link to="/dashboard/vehicle">
              <li>
                <div className="flex items-center mb-5 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg
